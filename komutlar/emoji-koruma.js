...
exports.run = async(client, message, args) => {
  ...
  if(!message.member.permissions.has("ADMINISTRATOR")) return message.channel.send(new Discord.MesageEmbed().setDescription("Bu Komutu Kullanabilmek İçin \`Yönetici\` Yetkisine Sahip Olmalısın !").setColor("RANDOM"))
