...
return message.channel.send(new Discord.MessageEmbed().setColor('BLACK').setDescription("Capslock engel başarıyla açıldı!").setFooter("Fadekoni"))
};
if(args[0] === "kapat"){
  db.delete(`capslock_${message.guild.id}`)
  return message.channel.send(new Discord.MessageEmbed().setColor("RANDOM").setDescription("Capslock engel başarılı bir şekilde kapatıldı!").setFooter("Fadekoni")) 
};
};
module.exports.conf = {
aliases: [], 
